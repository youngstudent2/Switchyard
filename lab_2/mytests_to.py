...
def switch_tests():
    ...
    s.add_interface('eth0', '40:00:00:00:00:01')
    s.add_interface('eth1', '40:00:00:00:00:02')
    s.add_interface('eth2', '40:00:00:00:00:03')
    ...
    s.expect(PacketOutputEvent("eth1", reqpkt, display=Ethernet), "Ethernet frame destined for 30:00:00:00:00:02 should be sent on eth1") 
    ...
    s.expect(PacketOutputEvent("eth0", resppkt, display=Ethernet), "Ethernet frame destined to 20:00:00:00:00:01 should be sent on eth0")
    '''
    ...
    '''
    # test case 4: server1 -> client
    '''
    print("run here")
    reqpkt = mk_pkt("10:00:00:00:00:03", "30:00:00:00:00:02", "192.168.1.100","172.16.42.2")
    s.expect(PacketInputEvent("eth0", reqpkt, display=Ethernet), "An Ethernet frame from 10:00:00:00:00:03 to 30:00:00:00:00:02 should arrive on eth0")
    s.expect(PacketOutputEvent("eth1", reqpkt, display=Ethernet), "Ethernet frame destined for 30:00:00:00:00:02 should be sent on eth1") 
    '''
